...
const analysisCacheKey='fiste-guiden-last-analysis-v24';
...
else if(['standard','satellite','hybrid','fishing','chart'].includes(savedUiState.mapStyle)) $('mapStyle').value=savedUiState.mapStyle;
